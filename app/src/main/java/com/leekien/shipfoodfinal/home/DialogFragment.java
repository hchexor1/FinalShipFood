...
public class DialogFragment extends android.support.v4.app.DialogFragment {
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        discount = Integer.parseInt(food.getDiscount().toString());
        tvPrice.setText(AppUtils.formatMoney(food.getPrice() * (100-discount)/100* num + ""+ "đ"));
//        tvPrice.setText(food.getPrice() + " " + "đ");
        ...
        imageViewCong.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                discount = Integer.parseInt(food.getDiscount().toString());
                tvPrice.setText(AppUtils.formatMoney(food.getPrice() * (100-discount)/100* num + ""));
                food.setPriceDat(food.getPrice() * num + "");
